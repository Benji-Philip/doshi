...
List<Widget> analysisPage(
  ...
  if (analysisOfExpensesThisMonth.isNotEmpty) {
    return [
      SliverToBoxAdapter(
        child: Padding(
                        ...
                        child: PieChart(
                            ...
                            PieChartData(
                                sections: List.generate(
                                    analysisOfExpensesThisMonth.length,
                                    (index) {
                              return PieChartSectionData(
                                  ...
                                  title:
                                      "${analysisOfExpensesThisMonth[index].categorySumPercent}%",
                                  value: double.parse(
                                      analysisOfExpensesThisMonth[index]
                                          .categorySumPercent),
                                  color: Color(
                                      analysisOfExpensesThisMonth[index]
                                              .categoryColor ??
                                                    ...
                                                    children: [
                                                      Padding(
                                                        ...
                                                        child: Container(
                                                          ...
                                                          width: 12,
                                                          decoration: BoxDecoration(
                                                              color: Color(analysisOfExpensesThisMonth[
                                                                          index]
                                                                      .categoryColor ??
                                                                  Colors.white
                                                                      .value),
      ...
      SliverToBoxAdapter(
        child: Padding(
          padding:
              const EdgeInsets.only(right: 21, left: 21, top: 10, bottom: 10),
          child: Row(
            mainAxisSize: MainAxisSize.max,
    ...
    return [
      SliverToBoxAdapter(
        child: Padding(
          padding: EdgeInsets.only(top: 65 + spaceFromTop, right: 21, left: 21),
          child: Row(
            mainAxisAlignment: MainAxisAlignment.start,
            mainAxisSize: MainAxisSize.max,
            children: [
