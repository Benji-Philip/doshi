...
final editBudgetText = StateProvider((state) => "Default");
...
class EditBudget extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<EditBudget> createState() => _AddBudgetState();
}

class _AddBudgetState extends ConsumerState<EditBudget> {
  ...
  void initState() {
    super.initState();
    _categoryController.text = ref.read(editBudgetText);
  }
