...
class EditSubCategory extends ConsumerStatefulWidget {
  final String parentCategory;
  final Id id;
  const EditSubCategory(
      {super.key, required this.id, required this.parentCategory});

  @override
  ConsumerState<EditSubCategory> createState() => _EditCategoryState();
}

class _EditCategoryState extends ConsumerState<EditSubCategory> {
  ...
  void initState() {
    super.initState();
    _categoryController.text = ref.read(categoryText);
  }
  @override
  void dispose() {
