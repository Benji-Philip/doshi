...
import 'package:doshi/onboarding/add_income_onboard_dialog.dart';
        ...
        child: Padding(
          ...
          child: Container(
              ...
              child: Padding(
                ...
                child: Padding(
                  padding: const EdgeInsets.only(top: 18.0, bottom: 34),
                  child: Flex(
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Transform.scale(
                            scale: 1.25,
                            child: Lottie.asset('lib/assets/lottie/cash.json', fit: BoxFit.scaleDown , alignment: Alignment.center,
                                repeat: false)),
                      ),
                      Padding(
