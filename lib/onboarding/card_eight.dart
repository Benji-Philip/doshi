...
class CardEight extends StatefulWidget {
  ...
  @override
  State<CardEight> createState() => _CardEightState();
}
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Transform.scale(
                            scale: 1.1,
                            child: Lottie.asset('lib/assets/lottie/ppl.json',
                      ...
                      Padding(
                        ...
                        child: Text(
                          "Thank you for trying out Doshi! I hope you enjoy using the app!",
                                    ...
                                    onTap: () {
                                      ...
                                      ref
                                          .read(appSettingsDatabaseProvider
                                              .notifier)
                                          .editSetting(
                                              7, "EndOnboarding", "true");
                                      ref.read(endOnBoarding.notifier).state =
                                          true;
                                    });
                              }),
                            ),
